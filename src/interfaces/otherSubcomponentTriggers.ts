...
export interface OtherSubcomponentTriggers {
  ...
  // for managing them when their mouse events are triggered by the user's mouse, additionally there is no need
  // to worry about the logic for going between click and default as useSubcomponentPreviewEventHandlers tracks
  // the hover event to populate the css inbetween those classes
