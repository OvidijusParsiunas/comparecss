...
export class MenuBaseSpecificSettings {
  ...
  private static generateMenuBaseSpecificSettings(): SubcomponentSpecificSettings {
    return {
  ...
  public static set(component: WorkshopComponent): void {
    component.baseSubcomponent.subcomponentSpecificSettings = MenuBaseSpecificSettings.generateMenuBaseSpecificSettings();
  }
}
