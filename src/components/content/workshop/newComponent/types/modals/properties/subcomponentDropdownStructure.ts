...
export default function getModalSubcomponentDropdownStructure(
    layer2Subcomponent: SubcomponentProperties, layer3Subcomponent: SubcomponentProperties, closeComponent: SubcomponentProperties,
    textSubcomponent1: SubcomponentProperties, textSubcomponent2: SubcomponentProperties, importedButtonStructure1: ImportedComponentStructure,
    importedButtonStructure2: ImportedComponentStructure): NestedDropdownStructure {
  return {
