...
export class CopyChildComponentModeCardEvents {
  ...
  public static mouseClick(workshopComponent: ComponentOptions, componentToBeCopied: WorkshopComponent): void {
    CopyChildComponentModeTempPropertiesUtils.copyComponentToTarget(workshopComponent.currentlySelectedComponent, componentToBeCopied);
    CopyChildComponentModeTempPropertiesUtils.copyLastSelectectedComponentToTarget(workshopComponent.currentlySelectedComponent, componentToBeCopied);
  ...
  public static mouseLeave(workshopComponent: ComponentOptions): void {
    ...
    if (currentlySelectedComponentForCopyChild) {
      CopyChildComponentModeTempPropertiesUtils.copyComponentToTarget(currentlySelectedComponent, currentlySelectedComponentForCopyChild, );
    } else {
